...
```{r}
ggplot(data = phil, mapping=aes(x=SVM, PSSM)) + geom_point() + ggtitle("SVM vs PSSM") + theme_classic()
ggplot(data = phil, mapping=aes(x=ANN, PSSM)) + geom_point() + ggtitle("ANN vs PSSM") + theme_classic()
